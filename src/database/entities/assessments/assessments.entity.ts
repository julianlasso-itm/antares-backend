...
import { KnowledgeGaps } from '../knowledge_gaps/knowledge-gaps.entity';
import { RolePerProfessional } from '../projects_management/role-per-professional.entity';
import { Users } from '../security/users.entity';
